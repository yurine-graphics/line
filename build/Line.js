...
function getCtrol(x0, y0, x1, y1, x2, y2, x3, y3) {
  ...
  Line.prototype.renderBg = function(context, padding, width, height, gridWidth, max, min) {
  ...
  Line.prototype.renderFg = function(context, padding, width, height, lineWidth) {
  }
