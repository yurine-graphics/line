...
function getGdr(context, top, y, fill) {
  ...
  Line.prototype.renderFg = function(context, height, lineHeight, lineWidth, breakLineWidth, left, bottom, top, right, stepX, stepY, stepV, max, min, xLineNum, yLineNum, width, height) {
    var self = this;
  ...
  Line.prototype.renderOne = function(context, item, lineHeight, color, index) {
    var self = this;
  ...
  Line.prototype.renderLine = function(context, coords, index, lineWidth, breakLineWidth, lineHeight, color, breakColor, breakDash, style, y, y0, left, right, xLineNum, yLineNum, reverse) {
    var self = this;
    switch(style) {
      case 'curve':
  ...
  Line.prototype.renderCurve = function(context, coords, index, y, y0, left, right, color, lineWidth, breakLineWidth, breakColor, breakDash, xLineNum, yLineNum, reverse) {
    if(coords.length) {
      var clone = [];
      coords.forEach(function(item) {
        if(item === null || item === undefined) {
  ...
  Line.prototype.renderStraight = function(context, coords, index, y, y0, left, right, color, lineWidth, breakLineWidth, breakColor, breakDash, xLineNum, yLineNum, reverse) {
    context.beginPath();
    var fill = this.option.areaColors[index];
    if(fill == 'transparent') {
      fill = null;
