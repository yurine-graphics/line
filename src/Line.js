...
class Line {
  ...
  render() {
    ...
    var [left, bottom, stepX, stepY] = self.renderBg(context, padding, width, height, gridWidth, min, lineHeight, fontSize, xNum, yNum, stepV, xLineNum, yLineNum, xlp, ylp);
    if(yNum == 1) {
      stepV = stepY >> 1;
    }
  ...
  renderY(context, padding, width, height, yNum, min, stepY, yLineNum, stepY2, fontSize, stepV, bottom, xlp, ylp) {
    var left = 0;
    var x = padding[3];
  ...
  renderX(context, padding, height, lineHeight, left, right, xNum, stepX, increase, xLineNum, increase2, xlp, ylp) {
    var self = this;
