...
class Line {
  ...
  renderFg(context, height, lineHeight, lineWidth, left, bottom, top, right, stepX, stepY, stepV, min, xLineNum, yLineNum) {
    var self = this;
  ...
  renderOne(context, item, lineWidth, lineHeight, color, right, bottom) {
    var self = this;
  ...
  renderLine(context, coords, index, lineWidth, lineHeight, color, style, y, y0, xLineNum, yLineNum) {
    var self = this;
    context.strokeStyle = color;
    context.lineWidth = lineWidth;
    switch(style) {
  ...
  renderCurve(context, coords, index, y, y0, color, lineWidth, xLineNum, yLineNum) {
    if(coords.length) {
      var clone = [];
      coords.forEach(function(item) {
        if(item === null || item === undefined) {
