...
class Line {
  ...
  render() {
    ...
    var [left, bottom, stepX, stepY] = self.renderBg(context, padding, width, height, gridWidth, min, lineHeight, fontSize, xNum, yNum, stepV, xLineNum, yLineNum, stepV2);
    self.renderFg(context, height, lineHeight, lineWidth, left, bottom, padding[0], stepX, stepY, stepV, min);
  }
  renderBg(context, padding, width, height, gridWidth, min, lineHeight, fontSize, xNum, yNum, stepV, xLineNum, yLineNum, stepV2) {
  ...
  renderFg(context, height, lineHeight, lineWidth, left, bottom, top, stepX, stepY, stepV, min) {
    var self = this;
  ...
  renderLine(context, coords, index, lineWidth, lineHeight, color, style, y, y0) {
    var self = this;
  ...
  renderCurve(context, coords, index, y, y0) {
    if(coords.length) {
      var clone = [];
      coords.forEach(function(item) {
        if(item === null || item === undefined) {
