...
class Line {
  ...
  renderX(context, padding, height, lineHeight, left, right, xNum, stepX, increase, xLineNum, increase2) {
  ...
  renderStraight(context, coords, index, y, left, right, color, lineWidth, breakLineWidth, breakColor, breakDash) {
    context.beginPath();
    var fill = this.option.areaColors[index];
    if(fill == 'transparent') {
      fill = null;
